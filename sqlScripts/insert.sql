...
values ('kapibara2018', 'qwerty123', 'Ivan', 'Jsonov', 'kapibara2018@mail.ru', '89218882021'),
...
insert into master (userId, experience, qualification)
values (1, 2, 'Курсы мастера по починке кухонной техники'),
       (2, 1, 'Курсы мастера по починке микроволновок'),
       (3, 10, 'Высшее образование в сфере починки кофемашин');



insert into day (name, shortName)
...
insert into schedule (dayId, masterId)
values (1, 1),
       (2, 1),
       (5, 1),
       (3, 2),
...
values ('Как починить туалет, если кинул туда петарду?', 'Никак. Советуем купить новый'),
       ('Можно ли отмыть плиту после 10 лет использования?', 'Да, нужно всего лишь одно народное средство…');

insert into techniqueType(name)
values ('Кухонная техника'),
       ('Техника из ванны'),
       ('Общее');

insert into technique (typeId, name)
values (1, 'Духовая печь'),
       (1, 'Микроволновая печь'),
       (1, 'Кофемашина'),
       (2, 'Стиральная машина');

insert into plan (techniqueId, name, cost)
values (1, 'Защити свою духовку!', 990),
       (2, 'Защити свою микроволновку!', 790),
       (3, 'Защити свою кофемашинку!', 1290);

insert into client (userId, address)
values (4, 'ул. Пушкина д. 45 кв. 23'),
       (5, 'ул. Пушкина д. 45 кв. 22'),
       (6, 'ул. Пушкина д. 45 кв. 21');

insert into owner (techniqueId, clientId, buyDate)
values (1, 1, '23.02.2012'),
       (2, 2, '01.12.2021'),
       (3, 3, '15.10.2017');


insert into subscriber (planId, clientId, startDate, finishDate)
values (1, 1, '24.03.2025', '24.09.2025'),
...
insert into orders (clientId, techniqueId, paymentTypeId, content, cost, date)
values (1, 1, 2, 'Сломалась духовка!!ПОМОГИТЕ!!!', 3000, '14.08.2019'),
       (2, 2, 1, 'Сломалась микроволновка!!ПОМОГИТЕ!!!', 2500, '18.02.2022'),
       (3, 3, 1, 'Сломалась кофемашинка!!ПОМОГИТЕ!!!', 4500, '06.06.2019');

insert into masterStatus (name)
values ('Работает'),
       ('Завершил заказ'),
       ('Был заменен');

insert into masterLog (orderId, masterId, masterStatusId)
values (1, 1, 2),
       (2, 2, 2),
       (3, 3, 2);

insert into feedback (clientId, masterId, content, rating)
values (1, 1, 'Спасибо мастеру! Все быстро починил!', 3),
...
values (1, 'Не получается создать заказ', 'Создание заказа'),
