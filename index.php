...
<div class='main'>
    ...
    <div class="btn_block">
        ...
        <?php
        $owners = DBPostgres::getOwnerHandler()->getByClient($_COOKIE['PROFILE_ID']);
        ?>
        <form method='POST' class='save-order-form' id='form' action="backend.php"
    ...
    <div class="list">
        <?php
        $currentOrders = DBPostgres::getOrderHandler()->getCurrentByClient($_COOKIE['PROFILE_ID']);
    ...
    <div class="list">
        <?php
        $oldOrders = DBPostgres::getOrderHandler()->getHistoryByClient($_COOKIE['PROFILE_ID']);
